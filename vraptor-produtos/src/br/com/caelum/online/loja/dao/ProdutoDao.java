...
public class ProdutoDao implements RepositorioDeProdutos {
	...
	private static void populaProdutosIniciais() {
		PRODUTOS.add(new Produto(1l, "iPod", "tocador de mp3 da apple","branco", 299.90));
		PRODUTOS.add(new Produto(2l, "iPad", "tablet da apple","branco", 1999.99));
		PRODUTOS.add(new Produto(3l, "212 for women", "perfume da carolina herrera","branco", 67.80));
		PRODUTOS.add(new Produto(4l, "Ivete Sangalo Ao Vivo", "cd da cantora","branco", 29.90));
	}
